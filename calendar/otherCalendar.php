<?php
    ...
    function makeCalendar($year, $month)
    {
        ...
        echo "<h2 class='text-center'><span onclick='nextMonth(-1)'><i class='fas fa-chevron-left mr-5 text-info' data-toggle='tooltip' title='Previous'></i></span>".date('F', mktime(0, 0, 0, $month, 10))."<span onclick='nextMonth(1)'><i class='fas fa-chevron-right ml-5 text-info' data-toggle='tooltip' title='Next'></i></span></h2>";
